...
public class CtrlSucursal implements ActionListener{
    ...
    private Sucursales frm;
    
    public CtrlSucursal(VoSucursal Vosu,DaoSucursal Daosu,Sucursales frm){
        this.Vosu=Vosu;
        this.Daosu=Daosu;
        this.frm=frm;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()== frm.btnagregar){
            if(frm.txtdireccion.getText().isEmpty()||frm.txtdireccion.getText().isEmpty()){
