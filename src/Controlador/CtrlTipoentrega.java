...
public class CtrlTipoentrega implements ActionListener {
    ...
    private Tipoentrega frm;
    
    public  CtrlTipoentrega(VoTipoentrega  Voti,DaoTipoentrega Daoti,Tipoentrega frm){
        this.Voti=Voti;
        this.Daoti=Daoti;
        this.frm=frm;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()== frm.btnagregar){
            if(frm.txttipo.getText().isEmpty()){
