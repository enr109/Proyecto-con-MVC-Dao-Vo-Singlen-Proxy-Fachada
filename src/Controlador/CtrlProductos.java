...
public class CtrlProductos implements ActionListener{
    ...
    public CtrlProductos(VoProductos Vope,DaoProductos Daope,Producto frm){
       this.Vope=Vope;
       this.Daope=Daope;
       this.frm=frm;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()== frm.btnagregar){
            if(frm.txtcosto.getText().isEmpty() || frm.txtprecio.getText().isEmpty()|| frm.txtproducto.getText().isEmpty()){
